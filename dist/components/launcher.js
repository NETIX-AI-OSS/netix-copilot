...
function Launcher({ onOpen }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("button", { type: 'button', className: 'nxcp-root nxcp-launcher', style: (0, theme_1.themeToCssVars)(theme), "aria-label": t('copilot.dock.label'), "data-expanded": expanded ? 'true' : 'false', onMouseEnter: () => setExpanded(true), onMouseLeave: () => setExpanded(false), onFocus: () => setExpanded(true), onBlur: () => setExpanded(false), onClick: () => {
            setExpanded(false);
            onOpen();
