...
function ModelTierSelector({ className }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("label", { className: `nxcp-tier-selector${className ? ` ${className}` : ''}`, "data-locked": locked ? 'true' : 'false', title: locked ? t('copilot.tier.locked') : t('copilot.tier.label'), children: [(0, jsx_runtime_1.jsx)("span", { className: 'nxcp-tier-orb', "aria-hidden": 'true' }), (0, jsx_runtime_1.jsx)("span", { className: 'nxcp-sr-only', children: t('copilot.tier.label') }), (0, jsx_runtime_1.jsx)("select", { className: 'nxcp-tier-select', "aria-label": t('copilot.tier.label'), value: tier, disabled: locked, onChange: changeTier, children: types_1.MODEL_TIERS.map((entry) => ((0, jsx_runtime_1.jsx)("option", { value: entry.key, children: t(`copilot.tier.${entry.key}`) }, entry.key))) }), (0, jsx_runtime_1.jsx)("span", { className: 'nxcp-tier-chevron', "aria-hidden": 'true' })] }));
}
